...
```{r}
#stat_combine_data <- combine_data |>
 # mutate(across(where(is.numeric), list(mean = mean, sd = sd, median = median), #.names = "{.col}_{.fn}"))
#View(stat_combine_data)
```
...
### \* In this Combine Tibble there is no missing values. 
